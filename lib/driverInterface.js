                    ...
                    if(loadedDrivers.indexOf(driverHandles[i]) == -1){
                        try {
                            ...
                            for(var j in drivers){
                                ...
                                var driverParams;
                                try {
                                    driverParams = params[driverHandles[i]].instances[0].params;
                                } catch (err) {}
                                driversList[newDriverId].init(newDriverId, driverParams, register, remove,  command);
                                newDriverId++;
                            }
